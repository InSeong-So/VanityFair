...
public class VanityFairStringUtil
{
    ...
    {
        return new DecimalFormat("###,###,###." + VanityFairStringUtil.repeat("0", scale)).format(num);
    }
    ...
    public static String CreateDataWithCheck(String dataString)
    {
        ...
        {
            throw new VanityFairRException("시간 변환에 실패했습니다. 에러 메세지 : " + e.getMessage());
        }
    ...
    {
        VanityFairStringUtil.lowerCheck = lowerCheck;
        VanityFairStringUtil.size = size;
        return init();
    }
}
