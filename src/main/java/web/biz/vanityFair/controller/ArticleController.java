...
public class ArticleController extends SisExtends
{
    ...
    public ModelAndView articleUpdateComplete(@PathVariable("articlesNumber") String articlesNumber, @PathVariable("articleSeqNo") String articleSeqNo, String title, String content, String sendMenu, MultipartFile uploadFile, HttpSession session, HttpServletRequest request,
