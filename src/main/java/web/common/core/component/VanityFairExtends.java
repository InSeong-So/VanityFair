...
import core.sql.XmlParsingQuery;
import core.sql.query.QueryFactory;
...
@AllArgsConstructor
@Configuration
public class VanityFairExtends
{
    ...
    protected VanityFairEncUtil vfEnc = VanityFairEncUtil.getInstance();
    ...
    protected HashMap<String, String> queryResultSet(String query, Class targetClass)
    {
        ...
        String xmlQuery = xmlParsingQuery.getElement(QueryFactory.class, query, null);
    ...
    protected String codeCreator(HttpServletRequest request)
    {
        ...
        log.info("[TEST] codeCreator_getYmd : " + VanityFairStringUtil.getYmd());
    ...
    protected String codeCreator()
    {
        ...
        String codeFirstName = VanityFairStringUtil.getYmdhms().substring(6, 8);
        log.info("codeFirstName : " + codeFirstName);
        String codeMiddleName = vfConf.getSpare();
        log.info("codeMiddleName : " + codeMiddleName);
        String codeLastName = VanityFairStringUtil.getYmdhms().substring(10, 12);
        log.info("codeLastName : " + codeLastName);
        String codeSuffix = VanityFairStringUtil.getYmdhms().substring(8, 10);
